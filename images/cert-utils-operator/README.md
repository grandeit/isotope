...
**Scanned:** 2026-02-11 01:34:32 UTC

## Overview

| Isotope | Critical | High | Medium | Low | Total | Fixable |
|---------|----------|------|--------|-----|-------|---------|
| **upstream** | 🔴 2 (🔧2) | 🟠 42 (🔧41) | 135 (🔧100) | 109 (🔧19) | 288 | 🔧 162 |
...
| CVE-2025-61730 | HIGH | stdlib | v1.19.13 | 1.24.12, 1.25.6 | During the TLS 1.3 handshake if multiple messages are sent in records ... |
| CVE-2025-68121 | HIGH | stdlib | v1.19.13 | 1.24.13, 1.25.7, 1.26.0-rc.3 | During session resumption in crypto/tls, if the underlying Config has ... |
...
| CVE-2025-22873 | MEDIUM | stdlib | v1.19.13 | 1.23.9, 1.24.3 | It was possible to improperly access the parent directory of an os.Roo ... |
