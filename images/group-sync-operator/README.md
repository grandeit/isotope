...
**Scanned:** 2025-12-16 14:05:19 UTC

## Overview

| Isotope | Critical | High | Medium | Low | Total | Fixable |
|---------|----------|------|--------|-----|-------|---------|
| **upstream** | 🔴 1 (🔧1) | 🟠 13 (🔧12) | 46 (🔧31) | 33 (🔧2) | 93 | 🔧 46 |
...
| CVE-2025-61729 | HIGH | stdlib | v1.21.13 | 1.24.11, 1.25.5 | crypto/x509: Excessive resource consumption when printing error string for host certificate validation in crypto/x509 |
...
| CVE-2025-61727 | MEDIUM | stdlib | v1.21.13 | 1.24.11, 1.25.5 | An excluded subdomain constraint in a certificate chain does not restr ... |
