...
**Scanned:** 2026-04-21 12:45:05 UTC

## Overview

| Isotope | Critical | High | Medium | Low | Total | Fixable |
|---------|----------|------|--------|-----|-------|---------|
| **upstream** | 🔴 2 (🔧2) | 🟠 43 (🔧33) | 201 (🔧76) | 249 (🔧11) | 495 | 🔧 122 |
| ubi-micro | 0 | 🟠 1 | 7 | 8 | 16 | 🔧 0 |
| ubi-minimal | 0 | 🟠 5 | 75 | 76 | 156 | 🔧 0 |
| ubi | 0 | 🟠 10 | 125 | 238 | 373 | 🔧 0 |
...
| CVE-2025-68121 | CRITICAL | stdlib | v1.24.4 | 1.24.13, 1.25.7, 1.26.0-rc.3 | crypto/tls: crypto/tls: Incorrect certificate validation during TLS session resumption |
...
| CVE-2026-4424 | HIGH | libarchive | 3.5.3-6.el9_6 | 3.5.3-9.el9_7 | libarchive: libarchive: Information disclosure via heap out-of-bounds read in RAR archive processing |
...
| CVE-2026-39883 | HIGH | go.opentelemetry.io/otel/sdk | v1.37.0 | 1.43.0 | opentelemetry-go: BSD kenv command not using absolute path enables PATH hijacking |
...
| CVE-2026-32280 | HIGH | stdlib | v1.24.4 | 1.25.9, 1.26.2 | crypto/x509: crypto/tls: golang: Go: Denial of Service vulnerability in certificate chain building |
| CVE-2026-32281 | HIGH | stdlib | v1.24.4 | 1.25.9, 1.26.2 | crypto/x509: golang: Go crypto/x509: Denial of Service via inefficient certificate chain validation |
| CVE-2026-32283 | HIGH | stdlib | v1.24.4 | 1.25.9, 1.26.2 | If one side of the TLS connection sends multiple key update messages p ... |
...
| CVE-2026-5121 | MEDIUM | libarchive | 3.5.3-6.el9_6 | 3.5.3-9.el9_7 | libarchive: libarchive: Arbitrary code execution via integer overflow in ISO9660 image processing |
...
| CVE-2026-27456 | MEDIUM | libfdisk | 2.37.4-21.el9 | - | util-linux: TOCTOU in the mount program when setting up loop devices |
...
| CVE-2026-5704 | MEDIUM | tar | 2:1.34-7.el9 | - | tar: tar: Hidden file injection via crafted archives |
...
| CVE-2026-27456 | MEDIUM | util-linux | 2.37.4-21.el9 | - | util-linux: TOCTOU in the mount program when setting up loop devices |
...
| CVE-2026-27456 | MEDIUM | util-linux-core | 2.37.4-21.el9 | - | util-linux: TOCTOU in the mount program when setting up loop devices |
...
| CVE-2026-39892 | MEDIUM | cryptography | 45.0.7 | 46.0.7 | cryptography: Cryptography: Buffer overflow via non-contiguous buffer in API |
...
| CVE-2026-32282 | MEDIUM | stdlib | v1.24.4 | 1.25.9, 1.26.2 | golang: internal/syscall/unix: Root.Chmod can follow symlinks out of the root |
| CVE-2026-32288 | MEDIUM | stdlib | v1.24.4 | 1.25.9, 1.26.2 | archive/tar: golang: Go's archive/tar package: Denial of Service via maliciously-crafted archive |
| CVE-2026-32289 | MEDIUM | stdlib | v1.24.4 | 1.25.9, 1.26.2 | html/template: golang: html/template: Cross-Site Scripting (XSS) via improper context and brace depth tracking in JS template literals |
