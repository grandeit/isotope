...
**Scanned:** 2026-03-31 12:41:20 UTC

## Overview

| Isotope | Critical | High | Medium | Low | Total | Fixable |
|---------|----------|------|--------|-----|-------|---------|
| **upstream** | 🔴 2 (🔧2) | 🟠 29 (🔧22) | 170 (🔧69) | 230 (🔧11) | 431 | 🔧 104 |
| ubi-micro | 0 | 0 | 4 | 8 | 12 | 🔧 0 |
| ubi-minimal | 0 | 🟠 4 | 57 | 57 | 118 | 🔧 0 |
| ubi | 0 | 🟠 7 | 101 | 219 | 327 | 🔧 0 |
...
|-----|----------|---------|-----------|-------|-------------|
| CVE-2026-33186 | CRITICAL | google.golang.org/grpc | v1.75.0 | 1.79.3 | golang: google.golang.org/grpc/grpc-go: google.golang.org/grpc/authz: gRPC-Go: Authorization bypass due to improper HTTP/2 path validation |
...
| CVE-2026-5121 | MEDIUM | libarchive | 3.5.3-6.el9_6 | - | A flaw was found in libarchive. On 32-bit systems, an integer overflow vulnerability exists in the zisofs block pointer allocation logic. A remote att |
