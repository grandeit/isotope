...
**Scanned:** 2025-12-15 03:57:39 UTC

## Overview

| Isotope | Critical | High | Medium | Low | Total | Fixable |
|---------|----------|------|--------|-----|-------|---------|
| **upstream** | 🔴 11 (🔧11) | 🟠 120 (🔧119) | 319 (🔧268) | 223 (🔧31) | 673 | 🔧 429 |
...
| CVE-2025-10966 | MEDIUM | curl | 7.61.1-25.el8_7.2 | - | curl: Curl missing SFTP host verification with wolfSSH backend |
| CVE-2025-9086 | MEDIUM | curl | 7.61.1-25.el8_7.2 | - | curl: libcurl: Curl out of bounds read for cookie path |
...
| CVE-2025-11081 | MEDIUM | gdb-gdbserver | 8.2-19.el8 | - | binutils: GNU Binutils out-of-bounds read |
...
| CVE-2025-10966 | MEDIUM | libcurl | 7.61.1-25.el8_7.2 | - | curl: Curl missing SFTP host verification with wolfSSH backend |
| CVE-2025-9086 | MEDIUM | libcurl | 7.61.1-25.el8_7.2 | - | curl: libcurl: Curl out of bounds read for cookie path |
...
| CVE-2025-5987 | MEDIUM | libssh | 0.9.6-3.el8 | - | libssh: Invalid return code for chacha20 poly1305 with OpenSSL backend |
...
| CVE-2025-5987 | MEDIUM | libssh-config | 0.9.6-3.el8 | - | libssh: Invalid return code for chacha20 poly1305 with OpenSSL backend |
...
| CVE-2025-9230 | MEDIUM | openssl-libs | 1:1.1.1k-7.el8_6 | - | openssl: Out-of-bounds read & write in RFC 3211 KEK Unwrap |
...
| CVE-2025-61727 | MEDIUM | stdlib | v1.18.10 | 1.24.11, 1.25.5 | An excluded subdomain constraint in a certificate chain does not restr ... |
